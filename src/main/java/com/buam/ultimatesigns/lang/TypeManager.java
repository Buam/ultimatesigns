...
public class TypeManager {
    ...
    /*public static void addNumber(com.buam.ultimatesigns.api.Variable variable) {
        numberTypes.add(new Number() {

            @Override
            public int get(Object... args) {
                return Integer.parseInt(variable.get());
            }
    ...
    public static void addText(com.buam.ultimatesigns.api.Variable variable) {
        textTypes.add(new Text() {
            @Override
